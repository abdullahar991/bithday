              ...
              <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 flex space-x-3 z-30">
                {[...Array(7)].map((_, i) => (
                  <div key={i} className="relative">
                    ...
                    {/* Flame */}
                    <div
                      className="absolute -top-4 left-1/2 transform -translate-x-[0%] w-3 h-5 rounded-full animate-flicker"
                      style={{
                    ...
                    {/* Flame glow */}
                    <div
                      className="absolute -top-5 left-1/2 transform -translate-x-[0%] w-6 h-6 rounded-full opacity-40 animate-pulse"
                      style={{
                    ...
                    {/* Wax drip */}
                    <div
                      className="absolute top-0 left-1/2 transform -translate-x-[0%] w-1 h-2 opacity-60 rounded-b-full"
                      style={{
